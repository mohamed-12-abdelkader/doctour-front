...
export default function AccountsPage() {
  ...
  const handleToggleStatus = async (
    ...
    try {
      ...
      showNotification(
        "success",
        !currentStatus ? "تم تفعيل الحساب" : "تم إلغاء التفعيل",
      );
      fetchStaff();
    } catch {
                        ...
                        <MenuRoot>
                          ...
                          <MenuContent>
                            ...
                            <MenuItem
                              value="status"
                              onClick={() =>
                                handleToggleStatus(staff.id, staff.isActive)
                              }
                              color={
                                staff.isActive ? "orange.600" : "green.600"
                              }
                            >
