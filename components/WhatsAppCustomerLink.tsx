...
type Props = {
  ...
  /** يمنع ارتفاع الحدث لصف الصفوف القابلة للنقر */
...
export function WhatsAppCustomerLink({
  ...
  return (
    <Box
      ...
      w={boxSize}
      h={boxSize}
      rounded={pill ? "full" : "md"}
      flexShrink={0}
      color="#25D366"
      bg={pill ? "green.50" : undefined}
      borderWidth={pill ? "1px" : undefined}
      borderColor={pill ? "green.100" : undefined}
      boxShadow={pill ? "sm" : undefined}
      _hover={{
        bg: pill ? "green.100" : "green.50",
        color: "#128C7E",
        boxShadow: pill ? "md" : undefined,
      }}
